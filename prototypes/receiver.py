...
# zeroValue defines the value which we will consider as zero.
# the range for considering a bit as zero is from 0 to zeroValue+70
# to consider a bit as one it will be from zeroValue+71 to infinite
